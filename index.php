                ...
                <div class="col-md-6">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8" style="text-align: left;">
                            ...
                            <h6>January 2015 to Present</h6>
                            <h6>January 2013 to December 2013</h6>
                            <ul>
                                <li>CPSC 221 (Alan Hu, TBD), Jan-Apr 2015</li>
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <img src="./img/lab126-small-white.png" alt="Amazon Lab126">
                        </div>
                        <div class="col-md-8" style="text-align: left;">
                            <h4>Amazon Lab126</h4>
                            ...
                            <ul>
                                <li>I was an intern on a team responsible for the Mayday feature in Fire tablets. (NDA)</li>
                            </ul>
                        </div>
                    </div>
                    <br /><br /><!-- NOTE NEED THIS DOUBLE BR TAG BETWEEN ELEMENTS FOR SPACING -->
                    <div class="row">
                        ...
                        <div class="col-md-8" style="text-align: left;">
                            ...
                            <ul>
                                <li>I was an intern in Windows working on an API as part of DirectX 12. (NDA)</li>
                            </ul>
                        </div>
                    </div>
                    <br /><br /><!-- NOTE NEED THIS DOUBLE BR TAG BETWEEN ELEMENTS FOR SPACING -->
                ...
                <div class="col-md-6">
                    ...
                    <div class="code" style="font-size: 14pt;">
                        <div class="row">
                            ...
                            <div class="col-xs-8"><div class="progress"><div class="progress-bar" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style="width: 60%;"></div></div></div>
                        </div>
                        <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-10 col-md-offset-2" style="text-align: left;">
                            <div class="row contact-info-row">
                                ...
                                <div class="col-md-9 contact-info-text"><img src="./img/email.png" alt="email address" /></div>
                            </div>
                            <div class="row contact-info-row">
                                <div class="col-md-3 contact-info-icon"><img src="./glyphicons/glyphicons_169_phone_edit.png" alt="Phone" /></div>
                                <div class="col-md-9 contact-info-text">Canada: <img src="./img/phone_can.png" alt="canadian phone number" /></div>
                            </div>
                            <div class="row contact-info-row">
                                <div class="col-md-3 contact-info-icon"><img src="./glyphicons/glyphicons_169_phone_edit.png" alt="Phone" /></div>
                                <div class="col-md-9 contact-info-text">USA: <img src="./img/phone_usa.png" alt="american phone number" /></div>
                            </div>
                            <div class="row contact-info-row">
...
<!-- Bootstrap -->
<script type="text/javascript" src="./js/bootstrap.js"></script><?php /*
<!-- Email form -->
